...
import com.acme.infra.demo.constants.AlbinoaddonConstants;



/**
 * This is the extension manager of the Albinoaddon extension.
 */
public class AlbinoaddonManager extends GeneratedAlbinoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AlbinoaddonManager.class.getName());
	 ...
	 */
	public static AlbinoaddonManager getInstance()
	{
		return (AlbinoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AlbinoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AlbinoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AlbinoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AlbinoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AlbinoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
